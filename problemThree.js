...
const suppliesFound = ["canned food", "aspirin", "bandages", "duct-tape", "coffee"]
function gatherSupplies(suppliesToLookFor){
    for (let arrleng = 0; arrleng < suppliesFound.length; arrleng++ ){
console.log("JARVIS has found some " + suppliesFound[arrleng] + "!")
    }
}

gatherSupplies(suppliesFound)
