...
function directTurretDefenceCommand(numOfTurrets, numOfDetectedZombies) {
    for (let zomTarget = 1; zomTarget <= numOfDetectedZombies; zomTarget++) {
        console.log("Directing " + numOfTurrets + " turrets' fire to zombie # " + zomTarget)
    }
}

directTurretDefenceCommand(8, 14)